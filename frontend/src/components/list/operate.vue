...
<template>
    <div class="flex space-x-2">
        <template v-if="isOverride">
            ...
            <a-button disabled type="text" shape="circle" class="flex justify-center items-center">
                <template #icon>
                    <RedoOutlined class="text-15 text-gray-300" />
                </template>
            </a-button>
        </template>
        <a-button v-if="!isOverride" type="text" shape="circle" class="flex justify-center items-center">
            <template #icon>
